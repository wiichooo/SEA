...
public class SoloNumeroValidator extends AbstractValidator {
    public final String DEFAULT_MESSAGE = "El campo no puede estar vacío.";
    
    public SoloNumeroValidator(JDialog parent, JTextField c) {
        super(parent, c, "El campo no puede estar vacío.");
    }
    public SoloNumeroValidator(JDialog parent, JTextField c, String message) {
